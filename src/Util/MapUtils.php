...
class MapUtils
{
	...
	/**
	 * Gets a map (associative array) from an array of map entries.
	 * A map entry is any object that has a key and value field.
	 *
	...
	/**
	 * Gets an array of map entries from a map (associative array).
	 * A map entry is any object that has a key and value field. An optional map entry class
	 * name can be specified for constructing the entries, otherise the stdClass is used.
	 *
	 * @param array $map a map from key to value
	 * @param string $mapEntryClassName an optional class name to use when constructing the map entries
	 * @return array an array of map entries built from the key-value pairs in the map
	 */
	...
	/**
	 * Determines if an array is a map (associative array) vs. a flat, numerically indexed array.
	 *
	...
	/**
	 * Converts a map (associative array) to a flat, numerically indexed array of method parameters.
	 * The method is used to determine the order of the parameters, and null values are using
