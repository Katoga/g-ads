...
class XmlUtils
{
	 ...
	 * If the XML cannot be loaded a string stripped of any newlines is returned.
	 *
	...
	/**
	 * Converts a DOMDocument to a stdClass object, where each element under the root node is a field.
	 * Atribute values are ignored.
	 *
	 * @param \DOMDocument $document the document to convert
	 * @return s Object the converted object
	 */
	...
	/**
	 * Converts a DOMElement to a stdClass object, where each child element is a field.
	...
	/**
	 * Converts an object to a DOMDocument.
	 * The root element name is passed in as a parameter, and each field of the object
	 * becomes a child element. Array values are represented by multiples instances of that element.
	 * Methods on the object are ignored. There is no support for XML attributes.
	 *
	...
	public static function ConvertObjectToDocument($object, $rootElementName)
	{
		...
		$document->appendChild(self::ConvertObjectToElement($object, $rootElementName, $document));
		return $document;
	}
	 ...
	 * @return s string the string value of the object
	 */
