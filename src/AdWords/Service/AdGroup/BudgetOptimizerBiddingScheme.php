 ...
 *
 * <p><b>Note:</b>
 * This bidding strategy has been deprecated and replaced with {@linkplain TargetSpendBiddingScheme TargetSpend}.
 * We no longer allow advertisers to opt into this strategy--{@code BudgetOptimizerBiddingScheme} solely exists so that advertisers can access campaigns that had specified this strategy.</p>
