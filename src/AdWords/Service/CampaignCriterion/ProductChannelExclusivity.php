...
/**
 * The product channel exclusivity dimension, which limits the availability of an offer between only local, only online, or both.
 * Only supported by campaigns of {@link AdvertisingChannelType#SHOPPING}.
 *
