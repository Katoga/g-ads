 ...
 * Top-level product types are at level 1, their children at level 2, and so on. We currently support up to 5 levels.
 * The user must specify a dimension type that indicates the level of the product type.
 * All cases of the the same subdivision must have the same dimension type (product type level).
 *
