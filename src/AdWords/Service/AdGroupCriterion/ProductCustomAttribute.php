 ...
 * As a product can have multiple custom attributes, the user must specify a dimension type that indicates the index of the attribute by which to subdivide.
 * All cases of the same subdivision must have the same dimension type (attribute index).
 *
